  ...
  return (
    ...
    sm:flex-row flex-col bg-black-gradient-2 rounded-[20px] box-shadow`}>
      ...
      <div className="flex-1 flex-col flex">
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Id rem quia iusto veritatis quos delectus deserunt magni.</p>
